...
<body>
    ...
    <div class="body-wrap">
        ...
        <div class="board-body">
            <div class="article">
                <form id="frm" action="${pageContext.request.contextPath}/yf_user/yf_user_contact" enctype="multipart/form-data" method="post">
                	<input type="hidden" id="qWriter" name="qWriter" value="${sessionScope.mUserName}" />
                    <div class="article-title">
                        <input type="text" class="m-b10" name="qTitle" id="qTitle" placeholder="제목" maxlength="40" tabindex="1" required style="border:1px solid transparent" />
                    </div>
                    <div class="article-body">
                        <textarea id="editor" name="qContent" style="border:1px solid  transparent"></textarea>
                        <script>
                    ...
                    <div class="attachment flex">
                        ...
                        <div style="width: 95%;"><input type="file" name="files" class="w100" style="border: 1px solid transparent"/></div>
                    </div>
                    <div class="btn-grp m-t30 center">
                        <button type="submit" id="finWrite" class="btn-on">작성완료</button>
                        <a href="${pageContext.request.contextPath}/yf_user/yf_user_contact" class="btn-off pointer">취소</a>
                    </div>
                </form>
            </div>
        </div>
